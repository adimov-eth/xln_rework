...
import { MachineID, Message, Transaction } from "../types/core";
import { decodeRLP, encodeRLP } from "../utils/encoding";
...
export class XLNWebSocketServer extends EventEmitter {
	...
	private async handleSignerCreate(
		clientId: string,
		message: WSMessage,
	): Promise<void> {
	...
	private async handleEntityCreate(
		clientId: string,
		message: WSMessage,
	): Promise<void> {
	...
	private async handleEntityPropose(
		clientId: string,
		message: WSMessage,
	): Promise<void> {
	...
	private async handleEntityVote(
		clientId: string,
		message: WSMessage,
	): Promise<void> {
	...
	private async handleChannelOpen(
		clientId: string,
		message: WSMessage,
	): Promise<void> {
