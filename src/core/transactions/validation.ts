import { Transaction, MachineType } from '../../types/core';
...
export class TransactionValidator {
    ...
    constructor(maxDataSize: number = 65536, maxFee: bigint = BigInt('1000000000000000000')) {
        this.nonces = new Map();
    ...
    validateTransactionTiming(transaction: Transaction, currentTime: number, maxAge: number = 300000): ValidationResult {
        ...
        if (transaction.timestamp > currentTime + 60000) { // 1 minute future tolerance
            return {
                valid: false,
    ...
    validateGasLimit(transaction: Transaction, gasLimit: number): ValidationResult {
