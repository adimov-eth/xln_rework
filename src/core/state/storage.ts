...
import { TreeConfig, EntityState } from '../../types/core';
import { encodeRLP, decodeRLP, createMachineId } from '../../utils/encoding';
...
export class MerkleStore {
    ...
    updateEntityState(signerId: Buffer, entityId: Buffer, state: EntityState): void {
    ...
    private createChannelKey(signerId: Buffer, entityId: Buffer, channelId: Buffer): Buffer {
        return createMachineId(
            Buffer.alloc(8),
            signerId,
            entityId,
